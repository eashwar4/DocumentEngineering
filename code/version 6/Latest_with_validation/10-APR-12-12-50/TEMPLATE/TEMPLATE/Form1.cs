            ...
            // try
            {
                ...
                //  else
                {
                    if (k == 1)
                    {
                        ...
                        sw1.WriteLine("<ANSWER1>" + answer1 + "</ANSWER1>");
                        sw1.WriteLine("<ANSWER2>" + answer2 + "</ANSWER2>");
                        sw1.WriteLine("<ANSWER3>" + answer3 + "</ANSWER3>");
                        sw1.WriteLine("<ANSWER4>" + answer4 + "</ANSWER4>");
                        sw1.WriteLine("<CORRECTANSWER>" + correctanswer + "</CORRECTANSWER></QA>");
                        sw1.Close();
                    }
                    else if (k == 0)
                    {
