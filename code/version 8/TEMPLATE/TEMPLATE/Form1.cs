...
namespace TEMPLATE
{
    ...
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            try
            {
                Image image = Image.FromFile("C:\\Users\\eashwar\\Desktop\\IMAGES\\TEMPLATE1.jpg");
                pictureBox1.Image = image;
                pictureBox1.Height = image.Height;
                pictureBox1.Width = image.Width;
                Image image2 = Image.FromFile("C:\\Users\\eashwar\\Desktop\\IMAGES\\TEMPLATE2.jpg");
                pictureBox3.Image = image2;
                pictureBox3.Height = image2.Height;
                pictureBox3.Width = image2.Width;
                Image image3 = Image.FromFile("C:\\Users\\eashwar\\Desktop\\IMAGES\\TEMPLATE3.jpg");
                pictureBox4.Image = image3;
                pictureBox4.Height = image3.Height;
                pictureBox4.Width = image3.Width;
                Image image4 = Image.FromFile("C:\\Users\\eashwar\\Desktop\\IMAGES\\TEMPLATE4.jpg");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string newfilename = Path.Combine(newfilename1, filename);
                FileStream aFile = new FileStream(newfilename, FileMode.Create, FileAccess.Write);
                StreamWriter sw = new StreamWriter(aFile);
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Class1.flashfilename = Path.GetFileName(sourcePath);
                // string filename = textBox2.Text;
                filename += ".xml";
                string newfilename1 = Path.Combine("C:\\Users\\eashwar\\Desktop\\PROJECT", textBox1.Text);
                string newfilename = Path.Combine(newfilename1, filename);
        ...
        private void button18_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                filename2 += ".zip";
                string newfilename1 = Path.Combine("C:\\Users\\eashwar\\Desktop\\PROJECT", textBox1.Text);
                string newfilenamezip = Path.Combine("C:\\Users\\eashwar\\Desktop\\PROJECT", filename2);
                Directory.CreateDirectory(newfilename1);
                string newfilename = Path.Combine(newfilename1, filename);
                string newfilenamertf = Path.Combine(newfilename1, filename1);
                FileStream aFile = new FileStream(newfilename, FileMode.Append, FileAccess.Write);
                ...
                if (Class1.tempnum == 4)
                {
                    sw.WriteLine();
                    sw.Write("<Flash>");
                    sw.Write(Path.GetFileName(Class1.flashfilename));
                    sw.Write("</Flash>");
                }
                ...
                try
                {
                    ...
                    archiver.BaseDir = @"C:\Users\eashwar\Desktop\PROJECT";
